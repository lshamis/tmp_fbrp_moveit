...
class PandaMoveGroup:
    ...
    def attach_object(self, object_name: str, link_name: str = "", touch_links: typing.List[str] = []) -> bool:
    ...
    def compute_cartesian_path(self,
                               ...
                               path_constraints: "ros2dict[moveit_msgs.Constraints]" = None) -> float:
    ...
    def plan(self) -> typing.Tuple[bool, "ros2dict[moveit_msgs.TrajectoryConstraints]", float, "ros2dict[moveit_msgs.MoveItErrorCodes]"]:
    ...
    def set_pose_targets(self,
                         poses: "ros2dict[geometry_msgs.Pose]",
                         end_effector_link: str = "") -> bool:
    ...
    def set_rpy_target(self,
                       rpy: typing.Tuple[float, float, float],
                       end_effector_link: str = "") -> bool:
    ...
    def set_trajectory_constraints(self, value: "ros2dict[moveit_msgs.TrajectoryConstraints]") -> None:
...
class PlanningScene:
    ...
    def add_box(self,
                name: str,
                pose: "ros2dict[geometry_msgs.Pose]",
                size: typing.Tuple[float, float, float] = (1, 1, 1)) -> None:
...
def onrequest(req):
    pkt = req.pkt
    try:
        req.reply(json.dumps({
            "err": "success",
            "result": eval(pkt.payload.decode())
        }))
